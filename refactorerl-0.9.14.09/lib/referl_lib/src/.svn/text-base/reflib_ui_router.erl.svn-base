...
-record(request_type, {
                     ...
                     modifiers=[%Database operations 
                                ...
                                %Clone IdentifiErl can only be executed as a singleton instance!
                     ...
                     non_modifiers=[%Database operations
                                   ...
                                   %Graph operations
                                    ...
                                    get_envs, get_env,
                                    %Dep. anal.s
                                    cyclic_fun_check_cycle,
                                    cyclic_fun_print_cycle,
                                    cyclic_fun_check_function,
                                    cyclic_fun_draw,
                                    cyclic_fun_get_deps,
                                    cyclic_fun_draw_cycles,
                                    cyclic_mod_check_module,
                                    cyclic_mod_print_cycle,
                                    cyclic_mod_check_cycle,
                                    cyclic_mod_draw,
                                    cyclic_mod_draw_cycles,
                                    cyclic_mod_get_deps,
                                    generate_smart_graph,
                                    %Directory sorting
                                    dir_sort, dir_sort_get_dirs, dir_sort_get_mods,
                                    %Function block analyses
                                    refusr_fb_regexp_re,fb_relations_get_relations,
                                    fb_relations_is_relation, fb_relations_draw,
                                    fb_relations_check_cycle, fb_relations_draw_cycles,
                                    %Interface layers

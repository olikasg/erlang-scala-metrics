...
;       ,(menu-from-group 'metrics)
		...
		(("Function block dependency analysis")
        ("Default FB analysis" refactorerl-depanal-fblock-default)
		("Define FBs with regexps" refactorerl-depanal-fblock-regexp))
        "--"
        (("Duplicated code analysis")
         ("Search in selected area..." refactorerl-dupcode-selected)

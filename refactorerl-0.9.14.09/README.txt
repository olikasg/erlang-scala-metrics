...
A wiki site (https://pnyf.inf.elte.hu/trac/refactorerl/wiki)
and a homepage (http://refactorerl.com) exist to our users delight.
The wiki aims to help our users understand the main features of
the tool and to guide their everyday use.
If you are new to RefactorErl, you can find some installation
and configuration instructions there. By visiting the homepage,
new versions of RefactorErl can be downloaded.
...
2. Edit your ~/.emacs file and add the following lines (changing "/path/to"
   ...
   (add-to-list 'load-path "/path/to/refactorerl-0.9.14.09/lib/referl_ui/emacs")
   (require 'refactorerl)
